...
===========================
2017/7/9         Tnias
完成了Score.cs的脚本，修改了GameManager.cs和BlockController.cs
建立了基本分数只读（按照距离计分，这样感觉分数刷新的让人有成就感）
创建了基本的游戏规则（试用），可以在坠毁后快速的重新归位继续，并刷新最高分，游戏可以无限重启，目标是刷新最高分
坠毁时会销毁所有可见的Block（除了最后一个，暂时留着它，否则会出错，可以修复这个bug，暂时还没打算去修复，因为这样感觉挺好）
修复了一些bug。。。我也忘了具体哪些了
===========================